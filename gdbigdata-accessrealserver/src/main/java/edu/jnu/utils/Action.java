...
public class Action {
	...
	public static CipherText HomoAdd(PublicKey pk, CipherText ct1, CipherText ct2) throws Exception {
	...
	//ct1^ct2
	public static CipherText powCip(PublicKey pk, CipherText ct1, CipherText ct2) throws Exception {
